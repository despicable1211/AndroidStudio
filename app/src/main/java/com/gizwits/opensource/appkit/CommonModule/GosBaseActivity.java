...
import com.gizwits.opensource.appkit.ControlModule.Activitycollect;
...
//		Toast.makeText(GosBaseActivity.this,getClass().getSimpleName(),Toast.LENGTH_SHORT).show();
		Log.d("GosBaseActivity.this", "当前Activity是:"+getClass().getSimpleName());
