...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
	...
	private void InitImageView() {
		...
		myll.setVisibility(GosDeploy.setUsingTabSetOn());//设置底部菜单栏是否可见
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_addDevice:
			...
			case R.id.share_device:
				intent = new Intent(GosMainActivity.this, SharedDeviceListAcitivity.class);
				startActivity(intent);
				break;
